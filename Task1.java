...
//Немного задание поменял. Вместо двух делителей можно задать несколько, а диапазон выбирать
    ...
    /**
     * Метод для получения с консоли только unsignedInteger значения.
...
class MyTools {
     ...
     * Является реализацией теста Миллера - Рабина.
     * Использует алгоритм быстрого возведения в степень по модулю
     *
